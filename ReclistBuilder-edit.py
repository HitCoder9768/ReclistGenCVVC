...
import sys, os, PyQt5.QtWidgets, json, feedparser, json, pathlib, urllib, subprocess
...
class MainWindow(QMainWindow):
    ...
    def generateReclistStyle1(self):
        ...
        # generate CCs
        # consonant 1 in the CC must never be a start consonant
        # consonant 2 in the CC must never be an end consonant
        ...
        for c1 in c1s:
            for c2 in c2s:
                # if we're not generating pure unvoiced CCs then skip those lines
